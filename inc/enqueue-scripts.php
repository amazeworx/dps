...
function dps_enqueue_scripts()
{
  ...
  wp_enqueue_style('dps', dps_asset('css/app.css'), array(), filemtime(dps_asset('css/app.css')));
  wp_enqueue_script('dps', dps_asset('js/app.js'), array(), filemtime(dps_asset('css/app.js')));
